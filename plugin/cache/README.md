...
* `bypass_zonefile` do not cache responses served from zonefiles by the *file* or *auto* plugins. Existing cached
  entries may still be served until they expire or are evicted.
